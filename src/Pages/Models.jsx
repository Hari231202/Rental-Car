...
import CarImg3 from "../images/cars-big/toyota-box.jpg";
import CarImg4 from "../images/cars-big/bmw-box.png";
import CarImg5 from "../images/cars-big/benz-box.jpg";
            ...
            <div className="models-div__box">
              <div className="models-div__box__img">
                ...
                <div className="models-div__box__descr">
                  ...
                  <div className="models-div__box__descr__name-price__details">
                    <span>
                      <i className="fa-solid fa-car-side"></i> &nbsp; Mhindra
                    </span>
                    <span style={{ textAlign: "right" }}>
                      4/5 &nbsp; <i className="fa-solid fa-car-side"></i>
                    </span>
            ...
            <div className="models-div__box">
              <div className="models-div__box__img">
                ...
                <div className="models-div__box__descr">
                  ...
                  <div className="models-div__box__descr__name-price__details">
                    <span>
                      <i className="fa-solid fa-car-side"></i> &nbsp; Fortuner
                    </span>
                    <span style={{ textAlign: "right" }}>
                      4/5 &nbsp; <i className="fa-solid fa-car-side"></i>
                    </span>
              ...
              <div className="models-div__box__img">
                ...
                <div className="models-div__box__descr">
                  ...
                  <div className="models-div__box__descr__name-price__details">
                    ...
                    <span>
                      <i className="fa-solid fa-car-side"></i> &nbsp;AMT
                    </span>
                    <span style={{ textAlign: "right" }}>
                      Diesel &nbsp; <i className="fa-solid fa-car-side"></i>
                    </span>
            ...
            <div className="models-div__box">
              <div className="models-div__box__img">
                ...
                <div className="models-div__box__descr">
                  ...
                  <div className="models-div__box__descr__name-price__details">
                    <span>
                      <i className="fa-solid fa-car-side"></i> &nbsp; Benz E
                    </span>
                    <span style={{ textAlign: "right" }}>
                      4/5 &nbsp; <i className="fa-solid fa-car-side"></i>
                    </span>
